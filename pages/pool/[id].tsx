    ...
    return (
        <Box display="flex" justifyContent={'space-evenly'}>
            <Box width="50%" my={5}>
                <StyledBox>
                    ...
                    <Box mt={5}>
                        <ul className={classes['pair-info']}>
                            <li className={classes['pair-info-item']}>
                                ...
                                <span className={classes['pair-info-item-value']}>
                                    $76,839,015
                                </span>
                            </li>
                            <li className={classes['pair-info-item']}>
                                <span className={classes['pair-info-item-label']}>
                                    Volume (24H)
                                </span>
                    ...
                    <Box mt={7} display="flex">
                        <Box>
                            <Box color={'#8b8ca7'}>Your pool share</Box>
                            <Box fontSize={40}>0%</Box>
                        </Box>
                        <Box ml={15}>
                            <Box color={'#8b8ca7'}>Your pool tokens</Box>
                            <Box fontSize={40}>0</Box>
                        </Box>
                    </Box>
                </StyledBox>
            ...
            <Box width="35%" my={5}>
                <StyledBox>
                    <InputFieldSingle
                        tokenImgPath={'/images/ether-logo.png'}
                        tokenName={'WETH.e'}
                        available={'1200'}
                    />
                    ...
                    <InputFieldSingle
                        available={'900'}
                        tokenImgPath={'/images/avax-logo.png'}
                        tokenName={'AVAX'}
                    />
